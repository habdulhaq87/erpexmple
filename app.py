...
# Streamlit app
def main():
    st.title("ERP Visualization for Retail Grocery Business")
    st.write("Explore transactions, filter data, and visualize key metrics.")
    ...
    selected_date = st.sidebar.multiselect("Select Date(s)", unique_dates, default=unique_dates)
    selected_category = st.sidebar.multiselect("Select Category(s)", unique_categories, default=unique_categories)
    selected_payment = st.sidebar.multiselect("Select Payment Method(s)", unique_payment_methods, default=unique_payment_methods)
